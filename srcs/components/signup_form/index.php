...
<script><?php include("{$path}/components/signup_form/index.js"); ?></script>
<div id="signup-wrapper" class="card">
  ...
  <form id="signup-form" method="post" action="/signup">
    ...
    <p id="signup-username-danger" class="help is-danger">Expected 4-20 lengths with alphanumeric or .-_ characters</p>
    ...
    <p id="signup-password-danger" class="help is-danger">Expected at least 6 uppercase, lowercase and numeric characters.</p>
    ...
    <p id="signup-confirmPassword-danger" class="help is-danger">Expected the same password</p>
